...
export declare const getResponsesObject: (schema: unknown, example: Record<string, any> | undefined, headers: Record<string, OpenAPIV3.HeaderObject | OpenAPIV3.ReferenceObject> | undefined, defs?: any) => OpenAPIV3.ResponsesObject;
