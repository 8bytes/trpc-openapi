...
const zodSchemaToOpenApiSchemaObject = (zodSchema, defs) => {
    // FIXME: https://github.com/StefanTerdell/zod-to-json-schema/issues/35
    const out = (0, zod_to_json_schema_1.default)(zodSchema, {
        target: 'openApi3',
        $refStrategy: 'root',
        definitions: defs !== null && defs !== void 0 ? defs : {},
...
const getResponsesObject = (schema, example, headers, defs) => {
    if (!(0, zod_2.instanceofZodType)(schema)) {
        throw new server_1.TRPCError({
    ...
    const successResponseObject = {
        ...
        content: {
            'application/json': {
                schema: zodSchemaToOpenApiSchemaObject(schema, defs),
                example,
            },
        },
    };
