...
const getOpenApiPathsObject = (appRouter, securitySchemeNames, defs) => {
    const pathsObject = {};
    ...
    (0, procedure_1.forEachOpenApiProcedure)(procedures, ({ path: procedurePath, type, procedure, openapi }) => {
        ...
        try {
            ...
            pathsObject[path] = Object.assign(Object.assign({}, pathsObject[path]), { [httpMethod]: Object.assign(Object.assign(Object.assign({ operationId: procedurePath.replace(/\./g, '-'), summary,
                    ...
                    })), { responses: (0, schema_1.getResponsesObject)(outputParser, (_e = openapi.example) === null || _e === void 0 ? void 0 : _e.response, openapi.responseHeaders, defs) }), (openapi.deprecated ? { deprecated: openapi.deprecated } : {})) });
        }
        catch (error) {
